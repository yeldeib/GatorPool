...
import { Row, Col, Container, Button, Input, Label, Form, UncontrolledPopover, PopoverHeader, PopoverBody } from 'reactstrap';
                ...
                <Container>
                    <Form onSubmit={this.handleSubmit.bind(this)}>
                        ...
                        <Row className="inputRow">
                            ...
                            <Col className="drive" xs={4}>
                                <Button id = "PopoverLegacy" color="link" type="button">What does this mean?</ Button>
                                <UncontrolledPopover trigger="legacy" placement="bottom" target="PopoverLegacy">
                                    <PopoverHeader>What does it mean to be a GatorPool driver?</PopoverHeader>
                                    <PopoverBody>
                                        If you own a car, you can sign up to offer rides for other GatorPool-ers to join. 
                                        By offering rides you can earn rewards in the form of flexbucks for on-campus dining.
                                    </PopoverBody>
                                </UncontrolledPopover>
                            </Col>
                            <Col className="driveNo">
